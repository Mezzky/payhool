<?php 
    ...
    if(isset($_GET['keyword'])) {
        ...
        $lastPaymentStatus = "Lunas"; // default value
        if (!empty($pembayaran)) {
            $lastPayment = end($pembayaran);
            if ($lastPayment['jumlah_bayar'] == 0) {
                $lastPaymentStatus = "Belum Lunas";
            }
        }
        ...
        <div class="tittle">
            ...
            <div class="tittle-right">
                <form action="" method="GET" autocomplete="off" class="search-form">
                    ...
                    <?php else : ?>
                    <input type="text" name="keyword" placeholder="Cari NIS" value="<?= $_GET['keyword']; ?>"
        ...
        <div class="table-content">
            ...
            <table border="0" cellspacing="0" cellpadding="10">
                ...
                <?php foreach ($pembayaran as $row) :
                    $canPay = $lastPaymentStatus == "Lunas";
                    if ($row["bulan"] == date("F") && $row["tahun"] == date("Y")) {
                        $canPay = false;
                    } ?>
                <tbody>
                    <tr>
            ...
            <div class="total-tagihan">
                ...
                <h3>Tagihan: Rp<?= number_format($totalNominal - (int) $tagihan['SUM(jumlah_bayar)'], 0, ',', '.'); ?>
                </h3>
